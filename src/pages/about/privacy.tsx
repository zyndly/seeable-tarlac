      ...
      <Layout>
        ...
        <Container>
          ...
          <ul className='list-disc ml-6'>
            <li className='hover:underline hover:text-lime-600'>The right to be informed.</li>
            <li className='hover:underline hover:text-lime-600'>The right of access.</li>
            <li className='hover:underline hover:text-lime-600'>The right to rectification.</li>
            <li className='hover:underline hover:text-lime-600'>The right to erasure.</li>
            <li className='hover:underline hover:text-lime-600'>The right to restrict processing.</li>
            <li className='hover:underline hover:text-lime-600'>The right to data portability.</li>
            <li className='hover:underline hover:text-lime-600'>The right to object.</li>
            <li className='hover:underline hover:text-lime-600'>Rights in relation to automated decision-making and profiling.</li>
          </ul>
